...
class BaseController extends Controller {
  ...
  async get_user_authoritys(user_id){
    ...
    let authorityAry = await this.ctx.service.incentive.authority.getUserAuthority(user_id || this.user.user_id);
    return authorityAry||[];
    //return this.ctx.session.user_authoritys||[];
  }
  async getAllAuthoritys(){
    let authorityAry = await this.ctx.service.incentive.authority.getAllAuthorityList();
    return authorityAry||[];
  }
